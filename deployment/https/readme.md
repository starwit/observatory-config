...
* 7. checkout project and go to `/smartparkingconfig/deployment/https`
...
* 10. execute `smartparkingconfig-docker-compose up -d` and `env-docker-compose up -d`
...
* go to https://pb.startwit.de/auth, login and create user for smartparkingconfig
